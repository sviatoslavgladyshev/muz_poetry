...
const childrenPricingSectionsTt: PricingSection[] = [
  ...
  },
  {
    ...
    description:
      "Ачкычлы сатыла торган абонементлар: музыка дәресләре + айга 8 сәгатьлек Мәдәни клубның 4 атнасы. Баланы җылы фильм күрсәтүләре, викториналар, музыка квизлары, өстәл уеннары, интерактив лекцияләр, мастер-класслар һәм яшьтәшләр белән тере аралашу көтә.",
    items: [
      {
        id: "club-month-group-4",
        label: "7",
